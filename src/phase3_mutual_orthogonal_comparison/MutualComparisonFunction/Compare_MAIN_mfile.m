...
nom_file_prefix = 'OPTIMIZED_CRITICAL_VOL_UNLUMPED';
...
tmp_1 = h5read(sprintf('%s%s',initial_directory_name,'/OPTIMIZED_CRITICAL_VOL_UNLUMPED1_.h5'),'/CELL_DATA/FIBER_RECON');
VizLayer(tmp_1,tmp_1)


% STEP 5: REMOVE ALL FIBER PROTRUDINGS
nom_file_prefix = 'OPTIMIZED_CRITICAL_VOL_UNLUMPED_NO_PROTRUDE';
