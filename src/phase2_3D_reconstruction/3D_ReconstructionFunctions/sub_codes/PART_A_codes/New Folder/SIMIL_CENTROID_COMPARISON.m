...
function [sieve_parameter_unique_CELL,remnant_ellipses]    =   SIMIL_CENTROID_COMPARISON (numberOfImageFiles,SLICE_UPDATE,CENTROID_UPDATE)
%%
sieve_parameter_unique_CELL                                =   cell(1,numberOfImageFiles);
remnant_ellipses                                           =   cell(1,numberOfImageFiles);

for tt       =    1 :  6 %numberOfImageFiles-1
% clc;
